...
import { 
  SiTailwindcss, SiNextdotjs, SiVite, SiPostman, SiTypescript 
} from 'react-icons/si';
...
export const SOCIAL_LINKS = [
  { 
    ...
    name: 'Linkedin', 
    icon: FaLinkedin, 
    url: 'https://www.linkedin.com/in/mohamed-magdy-shawky-bba0a4261', 
    color: '#0077b5' 
  },
  { 
    id: 2, 
    name: 'GitHub', 
    icon: FaGithub, 
    url: 'https://github.com/MohamedMagdy190', 
    color: '#333' 
  },
  { 
    id: 3, 
    name: 'Instagram', 
    icon: FaInstagram, 
    url: 'https://www.instagram.com/mohamed_magdy.2004/', 
    color: '#a21caf' 
  },
  { 
    id: 4, 
    name: 'Youtube', 
    icon: FaYoutube, 
    url: 'https://www.youtube.com/@mohamedmagdyelbana2744', 
    color: '#CD201F' 
  },
  { 
    id: 5, 
    name: 'Facebook', 
    icon: FaFacebook, 
    url: 'https://www.facebook.com/mohamed.magdy.756986?locale=ar_AR', 
    color: '#316FF6' 
  },
];
...
export const SKILL_CATEGORIES = [
  {
    ...
    skills: [
      { 
        ...
        icon: FaHtml5, 
        color: '#E34F26', 
        desc: 'Semantic, SEO, Accessibility' 
      },
      { 
        id: 2, 
        name: 'CSS3', 
      ...
      { 
        ...
        icon: SiTailwindcss, 
        color: '#06B6D4', 
        desc: 'Utility-first, Custom Config' 
      },
      { 
        id: 8, 
        name: 'Bootstrap', 
